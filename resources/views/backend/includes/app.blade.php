  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">ChasmaGhar</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item {{Request::is('product*', 'add.product', 'show.product','edit.product/*') ? 'menu-open':''}} ">
              <a href="#" class="nav-link {{Request::is('news*', 'add.product', 'show.product', 'edit.product/*') ? 'active':''}} ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item {{Request::is('add.product') ? 'menu-open':''}} ">
                  <a href="/add.product" class="nav-link {{Request::is('add.product') ? 'active':''}} ">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Create Product</p>
                  </a>
                </li>
                <li class="nav-item {{Request::is('product_all') ? 'menu-open':''}}">
                  <a href="/show.product" class="nav-link {{Request::is('show.product') ? 'active':''}}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Show Product</p>
                  </a>
                </li>
